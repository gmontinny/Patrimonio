	...
	<div class="modal-dialog modal-lg ">
		<div class="modal-content">
			<div class="modal-header bg-success">
				...
				<h6 class="modal-title">Baixa Sintética</h6>
			</div>
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-12">
						<button type="button" name="btnConfirmaBaixaGeral" id="btnConfirmaBaixaGeral" class="btn btn-primary btn-block" disabled>IMPRIMIR</button>					
					</div>
				</div>
			</div>
		</div>
