...
<script type="text/javascript" src="<%= request.getContextPath() %>/assets/js/cadastro/subgrupo.js"></script>
<script>
...
<div class="content" style="margin-top: 20px;">
	...
	<form action="" name="frm_subgrupo" id="frm_subgrupo" method="post" >
		<input type="hidden" name="codigo" id="codigo"/>
		<input type="hidden" name="acao" id="acao" value="${ativar}"/>
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">Cadastro de SubGrupo</h5>
				...
				<div class="row">
					<div class="col-md-12">
						<fieldset>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Descrição SubGrupo:</label>
									<input type="text" class="form-control" style="text-transform: uppercase;" name="descricaosubgrupo" id="descricaosubgrupo" placeholder="Entre com a descrição do subgrupo">
								</div>
							</div>
