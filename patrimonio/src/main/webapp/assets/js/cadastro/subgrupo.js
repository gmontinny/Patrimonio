...
function getEditar(id){
	...
	jQuery.ajax({
		 ...
		 success: function(msg){
			 $(".content").unblock();
			 $("#codigo").val(msg.idsubgrupo);
			 $("#descricaosubgrupo").val(msg.descsubgrupo);
	        ...
	        $('#frm_subgrupo').validate({
	            ...
	            submitHandler: function (form) {
					...
					jQuery.ajax({
						 type: "POST",
						 contentType: "application/x-www-form-urlencoded;charset=UTF-8",
						 url: path.val() + "/subgrupo/salvar",
						 cache: false,
						 data: {
							 "subgrupo.idsubgrupo":jQuery('input[name="codigo"]').val(),
							 "subgrupo.descsubgrupo":jQuery('input[name="descricaosubgrupo"]').val().toUpperCase(),
							 "subgrupo.grupo.idgrupo":jQuery('#grupo').val()							 
						 },
					   	 beforeSend: function( ) {
					   		loading(".content");
						 },
						 success: function(msg){
							...
							if(!jQuery.isBlank(msg)){
								...
								clear_form_elements("#frm_subgrupo");
