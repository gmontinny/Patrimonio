...
function getEditar(id){
	...
	jQuery.ajax({
		 ...
		 url: path.val() + "/secretaria/editar",
		 cache: false,
		 dataType: 'json',
		 data: {
			 "codigo":id
		 ...
		 success: function(msg){
			 $(".content").unblock();
			 $("#codigo").val(msg.idsecretaria);
			 $("#nomesecretaria").val(msg.nomsecretaria);
	...
	swalWithBootstrapButtons({
		  ...
		  if (result.value) {
	          ...
	          jQuery.ajax({
	        		 type: "POST",
	        		 contentType: "application/x-www-form-urlencoded;charset=UTF-8",
	        		 url: path.val() + "/secretaria/deletar",
	        		 cache: false,
	        		 data: {
	        			 "codigo":id
	        		 },
...
function atualizaGrid(){
	...
	var table = $('#grid-secretaria').DataTable();
	table.destroy();
	        ...
	        $('#frm_secretaria').validate({
	            ...
	            submitHandler: function (form) {
					...
					jQuery.ajax({
						 type: "POST",
						 contentType: "application/x-www-form-urlencoded;charset=UTF-8",
						 url: path.val() + "/secretaria/salvar",
						 cache: false,
						 data: {
							 "secretaria.idsecretaria":jQuery('input[name="codigo"]').val(),
							 "secretaria.nomsecretaria":jQuery('input[name="nomesecretaria"]').val().toUpperCase()
						 },
					   	 beforeSend: function( ) {
					   		loading(".content");
						 },
						 success: function(msg){
							...
							if(!jQuery.isBlank(msg)){
								...
								clear_form_elements("#frm_secretaria");
