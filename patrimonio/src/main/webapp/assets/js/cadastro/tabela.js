...
function getEditar(id){
	...
	jQuery.ajax({
		 ...
		 success: function(msg){
			 $(".content").unblock();
			 $("#codigo").val(msg.idtabela);
			 $("#nometabela").val(msg.nomtabela);
 			 $("#descricaotabela").val(msg.desctabela); 			 
 			 $("#ordemtabela").val(msg.ordtabela);
 			 $("#urltabela").val(msg.urltabela);
 			 $("#icontabela").val(msg.icontabela);
 			 $("#tipotabela").val(msg.tipotabela).trigger("change");
		 }
...
function atualizaGrid(){
	...
	var table = $('#grid-tabela').DataTable();
	table.destroy();
	...
	$('#grid-tabela').DataTable({
        "ajax": {
            "url": path.val() + "/tabela/grid",
            "dataSrc": ""
        },
        columnDefs: [
	        {
	        ...
	        $('#frm_tabela').validate({
	            ...
	            submitHandler: function (form) {
					...
					jQuery.ajax({
						 type: "POST",
						 contentType: "application/x-www-form-urlencoded;charset=UTF-8",
						 url: path.val() + "/tabela/salvar",
						 cache: false,
						 data: {
							 "tabela.idtabela":jQuery('input[name="codigo"]').val(),
							 "tabela.nomtabela":jQuery('input[name="nometabela"]').val(),
							 "tabela.desctabela":jQuery('input[name="descricaotabela"]').val(),
							 "tabela.icontabela":jQuery('input[name="icontabela"]').val(),
							 "tabela.urltabela":jQuery('input[name="urltabela"]').val(),
							 "tabela.ordtabela":jQuery('#ordemtabela').val(),
							 "tabela.tipotabela":jQuery('#tipotabela').val()
						 },
					   	 beforeSend: function( ) {
					   		loading(".content");
						 },
						 success: function(msg){
							...
							if(!jQuery.isBlank(msg)){
								...
								clear_form_elements("#frm_tabela");
								
								$('#tipotabela').val(null).trigger('change');
								$('#ordemtabela').val("");
