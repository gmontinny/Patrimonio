...
function getEditar(id){
	...
	jQuery.ajax({
		 ...
		 success: function(msg){
			 $(".content").unblock();
			 $("#codigo").val(msg.idsetor);
			 $("#nomesetor").val(msg.nomsetor);
	        ...
	        $('#frm_setor').validate({
	            ...
	            submitHandler: function (form) {
					...
					jQuery.ajax({
						 type: "POST",
						 contentType: "application/x-www-form-urlencoded;charset=UTF-8",
						 url: path.val() + "/setor/salvar",
						 cache: false,
						 data: {
							 "setor.idsetor":jQuery('input[name="codigo"]').val(),
							 "setor.nomsetor":jQuery('input[name="nomesetor"]').val().toUpperCase(),
							 "setor.secretaria.idsecretaria":jQuery('#secretaria').val()							 
						 },
					   	 beforeSend: function( ) {
					   		loading(".content");
						 },
