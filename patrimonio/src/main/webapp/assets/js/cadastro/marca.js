...
function getEditar(id){
	...
	jQuery.ajax({
		 ...
		 success: function(msg){
			 $(".content").unblock();
			 $("#codigo").val(msg.idmarca);
			 $("#descricaomarca").val(msg.descmarca);
	        ...
	        $('#frm_marca').validate({
	            ...
	            submitHandler: function (form) {
					...
					jQuery.ajax({
						 type: "POST",
						 contentType: "application/x-www-form-urlencoded;charset=UTF-8",
						 url: path.val() + "/marca/salvar",
						 cache: false,
						 data: {
							 "marca.idmarca":jQuery('input[name="codigo"]').val(),
							 "marca.descmarca":jQuery('input[name="descricaomarca"]').val().toUpperCase()
						 },
					   	 beforeSend: function( ) {
					   		loading(".content");
						 },
