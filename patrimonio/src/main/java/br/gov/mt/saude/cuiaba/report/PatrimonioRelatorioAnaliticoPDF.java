...
public class PatrimonioRelatorioAnaliticoPDF  implements Report{
	
	private final List<PatrimonioRelatorio> data;
	private Map<String, Object> parameters;
	
	public PatrimonioRelatorioAnaliticoPDF(List<PatrimonioRelatorio> data) {
		this.data = data;
	...
	public String getTemplate() {	
		return "patrimonio_analitico.jasper";
	}
