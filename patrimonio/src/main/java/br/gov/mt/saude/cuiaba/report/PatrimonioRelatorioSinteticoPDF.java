...
public class PatrimonioRelatorioSinteticoPDF implements Report{

	private final List<PatrimonioRelatorio> data;
	private Map<String, Object> parameters;
	
	public PatrimonioRelatorioSinteticoPDF(List<PatrimonioRelatorio> data) {
		this.data = data;
	...
	public String getTemplate() {	
		return "patrimonio_sintetico.jasper";
	}
